...
export default function AdminView({ profile, videoTiktokFeeds = [], communityPosts = [], savedTiktokFeeds = [], isOwner }: any) {
      ...
      <div className="border-t border-slate-200 dark:border-white/10">
        ...
        {(activeTab === "videos" || activeTab === "saved") && (
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4 mt-8 pb-20">
            {(activeTab === "videos" ? videoTiktokFeeds : savedTiktokFeeds).map((item: any) => (
            ...
            {(activeTab === "videos" ? videoTiktokFeeds : savedTiktokFeeds).length === 0 && (
